  ...
  return (
    <div className='flex flex-col md:flex-row-reverse py-8 justify-between items-center gap-12'>
      ...
      <div className='md:w-1/2 w-full px-4'>
        <h1 className='md:text-5xl text-2xl font-medium mb-7 text-zinc-700'>textoBiblico</h1>
        <p className='mb-10 text-zinc-600'>Compartilhe trechos da Bíblia na Internet. Para iniciar clique em pesquisar.</p>
